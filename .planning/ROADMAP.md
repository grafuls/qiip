...
- [x] 03-02-PLAN.md -- API routes, lifespan integration, and integration tests for all endpoints
...
- [x] 04-01-PLAN.md -- ConnectionTracker, NodeSelector strategy class, and model error factories with unit tests

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04-02-PLAN.md -- Wire routing into API routes, DI, lifespan, drain coordination, and integration tests
...
- [x] 05-01-PLAN.md -- CircuitBreaker, CircuitBreakerRegistry, health checker thread, ResilienceSettings, and unit tests
